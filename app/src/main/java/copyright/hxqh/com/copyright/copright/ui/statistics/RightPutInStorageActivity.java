...
public class RightPutInStorageActivity extends FragmentActivity {
    ...
    protected String[] right = new String[]{
            "全部", "复制权", "发行权", "出租权", "展览权", "放映权", "广播权", "摄制权", "翻译权", "汇编权", "表演权", "改编权",
            "录音者权","录像者权","信息网络传播权","其他","表演者权","广播电视组织权"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rightput);
    ...
    protected void initView() {
        ...
        json2 = HttpConnect.getRightPutInStorageJson(this,resourcekind,"pie","rightPutInStorage",rightkinds);
        titleTextView = (TextView) findViewById(R.id.menu_title);
        titleTextView.setText("权利项入库情况占比");
    ...
    private View.OnClickListener righttypeOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            showDialog1();
        }
    ...
    private void showDialog1() {
        if (right.length % 2 == 0){
            rightkinds = right[(right.length/2)];
        }else if (right.length % 2 == 1){
            resourcekind = right[(right.length/2+1)];
        }
        mCameraDialog = new Dialog(this, R.style.my_dialog);
        LinearLayout root = (LinearLayout) LayoutInflater.from(this).inflate(
                R.layout.right_dialog, null);
        LoopView loopView = (LoopView) root.findViewById(R.id.loopView);
        root.findViewById(R.id.right_cancel).setOnClickListener(btnlistener);
        root.findViewById(R.id.right_sure).setOnClickListener(btnlistener);
        mCameraDialog.setContentView(root);
        // 滚动监听
        loopView.setListener(new OnItemSelectedListener() {
            @Override
            public void onItemSelected(int index) {
                rightkinds = right[index];
            }
        });

        // 设置原始数据
        loopView.setItems(Arrays.asList(right));
    ...
    private View.OnClickListener btnlistener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (i == R.id.text_sure) {
                ...
                json2 = HttpConnect.getRightPutInStorageJson(RightPutInStorageActivity.this,resourcekind,"pie","rightPutInStorage",rightkind.getText().toString());
                getData(json2);
...
//            data.setAxisYLeft(axisY);
    ...
    private void initPieDatas() {
        ...
        if (data != null){
            ...
            Toast.makeText(RightPutInStorageActivity.this, "暂无数据", Toast.LENGTH_SHORT).show();
        }
        //点击动画开启

...
import copyright.hxqh.com.copyright.copright.ui.statistics.adapter.ProductWarningAdapter;
...
public class ProductEarlyWarningActivity  extends FragmentActivity {
    ...
    private ProductWarningAdapter productWarningAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_productwarn);
        ...
        //初始化自定义适配器
        productWarningAdapter =  new ProductWarningAdapter(fm);
        //绑定自定义适配器
        mViewPager.setAdapter(productWarningAdapter);
    ...
    private void initViewPageBar(){
        ...
        String[] labels = { "冲突", "期限", "合同","截稿","地域", "其余","语种"};
        for (int i = 0; i < labels.length; i++) {
            ...
            LinearLayout.LayoutParams paramss = new LinearLayout.LayoutParams(width/7, LinearLayout.LayoutParams.MATCH_PARENT, 1);
...
//        productWarningAdapter.setCount(labels.length);

...
public class AuthorResRelAdapter extends ArrayAdapter {
    private LayoutInflater inflater;
    private int resource;

    public AuthorResRelAdapter(@NonNull Context context, int resource, @NonNull List<AuthorResRel> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AuthorResRel item = (AuthorResRel) this.getItem(position);

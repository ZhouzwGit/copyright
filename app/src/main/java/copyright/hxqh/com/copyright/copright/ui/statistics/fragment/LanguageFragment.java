...
public class LanguageFragment extends BaseFragment {
    ...
    public static LanguageFragment newInstance(int num) {
    ...
    private void getData(final JSONObject json) {
        final String url = "http://118.190.115.150:8889/jeesite/htjk/apphttpjk/productEarlyWarningfive";

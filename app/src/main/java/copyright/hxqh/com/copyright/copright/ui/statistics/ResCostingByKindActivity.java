...
public class ResCostingByKindActivity extends FragmentActivity {
    ...
    protected void initView() {
        ...
        json2 = HttpConnect.getWorksPropertyJson(ResCostingByKindActivity.this,resourcekind,"pie");
    ...
    private View.OnClickListener imag_downOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (startAnaim()) {
                ...
                resCostAdapter = new ResCostAdapter(ResCostingByKindActivity.this,itemY3,text3, (ArrayList<Float>) mRatios3);
                recyclerView.setAdapter(resCostAdapter);
    ...
    private void getData(final JSONObject json) {
        final String url = "http://118.190.115.150:8889/jeesite/htjk/apphttpjk/resCostingByKind";

...
public class RightCostingByResActivity  extends FragmentActivity {
    ...
    protected void initView() {
        ...
        json2 = HttpConnect.getRightCostJson(RightCostingByResActivity.this,resourcekind,"pie",resourcename);
    ...
    private View.OnClickListener imag_downOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (startAnaim()) {
                ...
                resCostAdapter = new ResCostAdapter(RightCostingByResActivity.this,data, text, (ArrayList<Float>) mRatios);
                recyclerView.setAdapter(resCostAdapter);
            } else {
                resCostAdapter.notifyDataSetChanged();
                resCostAdapter = new ResCostAdapter(RightCostingByResActivity.this,itemY3,text3, (ArrayList<Float>) mRatios3);
                recyclerView.setAdapter(resCostAdapter);
    ...
    private View.OnClickListener btnlistener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (i == R.id.text_sure) {
                ...
                json2 = HttpConnect.getRightCostJson(RightCostingByResActivity.this,textresourcekind.getText().toString(),"pie",textresourcename.getText().toString());
                getData(json2);
    ...
    private void getData(final JSONObject json) {
        final String url = "http://118.190.115.150:8889/jeesite/htjk/apphttpjk/rightCostingByRes";
        new AsyncTask<String, String, ResCostingByKind>() {
            ...
            protected void onPostExecute(ResCostingByKind preoducts) {
                ...
                if (data == null){
                    ...
                    pieChartView.setVisibility(View.GONE);
                    liner_detail.setVisibility(View.GONE);
                    resCostAdapter = new ResCostAdapter(RightCostingByResActivity.this,data,text, (ArrayList<Float>) mRatios3);
                    recyclerView.setAdapter(resCostAdapter);
                }else {
    ...
    private void initPieDatas() {
        ...
        if (data != null){
            ...
            Toast.makeText(RightCostingByResActivity.this, "暂无数据", Toast.LENGTH_SHORT).show();
        }

...
import copyright.hxqh.com.copyright.copright.ui.statistics.entity.Series;
...
public class WorksCountActivity extends FragmentActivity {
    ...
    private WorksCountAdapter worksCountAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workscount);
        ...
        //初始化自定义适配器
        worksCountAdapter =  new WorksCountAdapter(fm);
        //绑定自定义适配器
        mViewPager.setAdapter(worksCountAdapter);
        ...
        myOnPageChangeListener.init(0, null, mHorizontalScrollView, mViewPager, new ProductSelectCallBack() {
            ...
            public void deal(int index) {
                worksCountAdapter.setStorageCounts(storageCountsList.get(index));
            }
        });
        mViewPager.setOnPageChangeListener(new LazyViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(final int position) {
                worksCountAdapter.setStorageCounts(storageCountsList.get(position));
                switchTab(position);
            }
    ...
    protected void initView() {
        ...
        json2 = HttpConnect.getPutInStorageJson(this,resourcekind,"pie","putInStorage");
        mBasIn = new BounceTopEnter();
        mBasOut = new SlideBottomExit();
        titleTextView = (TextView) findViewById(R.id.menu_title);
        titleTextView.setText("作品入库情况占比");
    ...
    private void initViewPageBar(){
        ...
        worksCountAdapter.setCount(labels.length);
        worksCountAdapter.setStorageCounts(storageCountsList.get(0));

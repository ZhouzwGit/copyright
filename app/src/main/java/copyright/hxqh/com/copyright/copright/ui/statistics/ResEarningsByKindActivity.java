...
public class ResEarningsByKindActivity  extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rescostingbykind);
        ButterKnife.bind(this);
        initView();
    }
    protected void initView() {
        json = HttpConnect.getBasicJson(this);
        json2 = HttpConnect.getWorksPropertyJson(ResEarningsByKindActivity.this,resourcekind,"pie");
        titleTextView = (TextView) findViewById(R.id.menu_title);
        titleTextView.setText("资产价值成本分析");
        item_tittle.setText("按作品类型的收入统计");
    ...
    private View.OnClickListener imag_downOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (startAnaim()) {
                ...
                resCostAdapter = new ResCostAdapter(ResEarningsByKindActivity.this, (ArrayList<String>) data, text, (ArrayList<Float>) mRatios);
                recyclerView.setAdapter(resCostAdapter);
            } else {
                resCostAdapter = new ResCostAdapter(ResEarningsByKindActivity.this,itemY3,text3, (ArrayList<Float>) mRatios3);
                recyclerView.setAdapter(resCostAdapter);
    ...
    private void getData(final JSONObject json) {
        final String url = "http://118.190.115.150:8889/jeesite/htjk/apphttpjk/resEarningsByKind";
        new AsyncTask<String, String, ResCostingByKind>() {
            ...
            protected void onPostExecute(ResCostingByKind preoducts) {
                ...
                if (data == null){
                    ...
                    pieChartView.setVisibility(View.GONE);
                    liner_detail.setVisibility(View.GONE);
                    resCostAdapter = new ResCostAdapter(ResEarningsByKindActivity.this, (ArrayList<String>) data,text, (ArrayList<Float>) mRatios3);
                    recyclerView.setAdapter(resCostAdapter);
                }else {
    ...
    private void initPieDatas() {
        ...
        if (data != null){
            ...
            Toast.makeText(ResEarningsByKindActivity.this, "暂无数据", Toast.LENGTH_SHORT).show();
        }
        if (itemY.size() < 3){
            liner_detail.setVisibility(View.GONE);

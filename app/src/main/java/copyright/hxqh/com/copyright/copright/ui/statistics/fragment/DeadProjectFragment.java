...
public class DeadProjectFragment  extends BaseFragment {
    ...
    public static DeadProjectFragment newInstance(int num) {
        DeadProjectFragment fragment = new DeadProjectFragment();
    ...
    private void getData(final JSONObject json) {
        final String url = "http://118.190.115.150:8889/jeesite/htjk/apphttpjk/productEarlyWarningthree";

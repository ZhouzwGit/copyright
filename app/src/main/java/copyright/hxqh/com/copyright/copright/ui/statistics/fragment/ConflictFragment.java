...
import copyright.hxqh.com.copyright.copright.ui.statistics.adapter.PropertyFragment;
...
public class ConflictFragment extends BaseFragment {
    ...
    public static ConflictFragment newInstance(int num) {
    ...
    private void getData(final JSONObject json) {
        final String url = "http://118.190.115.150:8889/jeesite/htjk/apphttpjk/productEarlyWarningzero";
    ...
    private void initPieDatas() {
        ...
        if (serieslist != null){
            ...
            text1.setText("权利项使用方式冲突");
            text2.setText("未发生冲突权利项");
            for (int i = 0;i<serieslist.size();i++){

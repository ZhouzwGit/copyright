...
import copyright.hxqh.com.copyright.copright.ui.contract.RightDialogActivity;
...
public class RightAdapter extends ArrayAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.resname.setText(item.getResourcename());
        viewHolder.resname.setTextSize(12);
        viewHolder.rightname.setText(item.getCopyright());
